...
public final class C19313c1 extends AbstractC19358r1 {

    /* renamed from: t */
    private final HashMap f95909t;

    /* renamed from: u */
    private final C29071c f95910u;

    /* renamed from: ga0.c1$a */
    /* loaded from: classes6.dex */
    ...
    public C19313c1(InterfaceC18319c interfaceC18319c, String str, HashMap hashMap, C29071c c29071c) {
        ...
        this.f95909t = hashMap;
        this.f95910u = c29071c;
    }
    ...
    public void run() {
        ...
        int i11;
        C18316b c18316b;
        this.f95910u.m145238b();
        if (this.f95910u.m145238b() != 0) {
            mo205i9(new C18316b("ACTION_SEARCH_TASK_RESULT_ADD_DATA", AbstractC29075g.m145256c(AbstractC29076h.e.f134819b, m101455l(), new ArrayList(), AbstractC29072d.c.f134805a, this.f95910u), null, null, 12, null));
        }
        ...
        try {
            ...
            C21753c m95860n = C18027a.Companion.m95862a().m95860n(m101455l(), null, null, EnumC2382z.f9947t, this.f95910u.m145238b(), 125, this);
            if (isCancelled()) {
                return;
            }
            C29071c m101098g = C19318e0.Companion.m101098g(this.f95910u, m95860n.m112206b(), 100, 25);
            ...
            for (MediaStoreItem mediaStoreItem : m95860n.m112206b()) {
                ...
                mediaStoreItem.m40615x0(EnumC2382z.f9947t, compile, i12);
                try {
                    CharSequence m40607q = mediaStoreItem.m40607q();
                    if (m40607q instanceof SpannableString) {
                        spannableString = (SpannableString) m40607q;
                    } else {
                        spannableString = null;
                    }
                    if (spannableString != null) {
                        CharSequence m40607q2 = mediaStoreItem.m40607q();
                        if (m40607q2 != null) {
                            i11 = m40607q2.length();
                        } else {
                            i11 = 0;
                        }
                        spannableString.getSpans(i12, i11, Object.class);
                    }
                } catch (Exception e11) {
                    e11.printStackTrace();
                }
                    ...
                    if (AbstractC25495a.m132079d(mediaStoreItem.m40599m().mo95039W2())) {
                        ...
                        if (m4472f != null && m4472f.m153781r().length() > 0) {
                            if (!C21927m.m114302u().m114345m("group_" + m4472f.m153781r())) {
                                ...
                                arrayList.add(new AbstractC29069a.e(8192, mediaStoreItem, m119251g));
                            }
                        }
                    } else if (this.f95909t.containsKey(mediaStoreItem.m40599m().mo95039W2())) {
            ...
            mo205i9(new C18316b(str2, AbstractC29075g.m145256c(AbstractC29076h.e.f134819b, m101455l(), arrayList, AbstractC29072d.d.f134806a, m101098g), null, null, 12, null));
        } catch (Exception e12) {
            e12.printStackTrace();
            if (isCancelled()) {
                return;
            ...
            mo205i9(new C18316b(str, AbstractC29075g.m145256c(AbstractC29076h.e.f134819b, m101455l(), new ArrayList(), AbstractC29072d.a.f134803a, this.f95910u), null, null, 12, null));
        }
    }

    public /* synthetic */ C19313c1(InterfaceC18319c interfaceC18319c, String str, HashMap hashMap, C29071c c29071c, int i11, AbstractC19060k abstractC19060k) {
