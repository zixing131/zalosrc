...
public final class C29025n0 {

    /* renamed from: b */
    private static volatile C29025n0 f134370b;

    /* renamed from: a */
    public final String f134371a = C29025n0.class.getSimpleName();

    /* renamed from: a */
    public static synchronized C29025n0 m145019a() {
        C29025n0 c29025n0;
        synchronized (C29025n0.class) {
            try {
                if (f134370b == null) {
                    synchronized (C29025n0.class) {
                        try {
                            if (f134370b == null) {
                                f134370b = new C29025n0();
                            }
                        } finally {
                        }
                    }
    ...
    /* renamed from: b */
    public void m145020b(RequestPacket requestPacket) {
        String valueOf;
        String m104886o0;
        int i11;
        int i12;
        ...
        if (requestPacket.m93284g() == 2 || requestPacket.m93284g() == 3 || requestPacket.m93284g() == 4) {
            if (requestPacket.m93278a() == 1) {
                if (requestPacket.m93289k() == 0) {
                    C29632i.m147326E0().f89373e = true;
                    return;
