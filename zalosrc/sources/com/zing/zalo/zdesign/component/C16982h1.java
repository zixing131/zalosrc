...
/* renamed from: com.zing.zalo.zdesign.component.h1 */
/* loaded from: classes7.dex */
public class C16982h1 extends C16719g implements InterfaceC16976f1 {

    /* renamed from: D0 */
    private C25807a f86790D0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16982h1(Context context) {
        super(context);
        AbstractC19074t.m100208f(context, "context");
        this.f86790D0 = new C25807a(new WeakReference(this));
    }

    @Override // com.zing.zalo.uidrawing.C16719g
    /* renamed from: M0 */
    public void mo89109M0(C16719g.c cVar) {
        C25807a c25807a = this.f86790D0;
