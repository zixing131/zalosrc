...
public final class TextSheet extends ResultSheet {

    /* renamed from: b1 */
    private C23625e f49153b1;

    /* renamed from: c1 */
    private C23623c f49154c1;

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: NL */
    public static final void m49600NL(C16716d c16716d, C1421e c1421e) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: OL */
    public static final void m49601OL(TextSheet textSheet, C16719g c16719g) {
        InterfaceC26029r interfaceC26029r;
        String str;
        AbstractC19074t.m100208f(textSheet, "this$0");
        InterfaceC1801w m92650VI = textSheet.m92650VI();
        ...
        if (interfaceC26029r != null) {
            Bundle m92642L3 = textSheet.m92642L3();
            if (m92642L3 == null || (str = m92642L3.getString("name")) == null) {
                str = "";
            }
            interfaceC26029r.mo49336w6(textSheet, str, "primary-button");
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: PL */
    public static final void m49602PL(TextSheet textSheet, C16719g c16719g) {
        InterfaceC26029r interfaceC26029r;
        String str;
        AbstractC19074t.m100208f(textSheet, "this$0");
        InterfaceC1801w m92650VI = textSheet.m92650VI();
        ...
        if (interfaceC26029r != null) {
            ...
            interfaceC26029r.mo49336w6(textSheet, str, "more-button");
        }
    }
    ...
    protected void mo45682lL(LayoutInflater layoutInflater, LinearLayout linearLayout, Bundle bundle) {
        ...
        AbstractC16768f.m89489a(linearLayout).m89430n(new InterfaceC27367c() { // from class: ry.v
            @Override // p558uu.InterfaceC27367c
            /* renamed from: b */
            public final void mo87294b(C1421e c1421e) {
                TextSheet.m49600NL(C16716d.this, c1421e);
            }
        });
        ...
        c23625e.m123844o1().setIdTracking("scan_qr_result_text_preview");
        C16979g1 m123844o1 = c23625e.m123844o1();
        C0708i c0708i = new C0708i();
        c0708i.m1072c("src_scan", i11);
        m123844o1.setTrackingExtraData(c0708i);
        c23625e.m123845p1().m111958F1(AbstractC8020f0.str_scan_qr_code_text);
        C21697g m123846q1 = c23625e.m123846q1();
        Bundle m92642L32 = m92642L3();
        if (m92642L32 != null) {
            str = m92642L32.getString("body", "");
        } else {
            str = null;
        }
        m123846q1.m111959G1(str);
        c23625e.m123846q1().mo111964L1(AbstractC23136l9.m118712h(c23625e.getContext(), 15.0f));
        c23625e.m123846q1().m111953A1(3);
        c16716d.m89001g1(c23625e);
        this.f49153b1 = c23625e;
        Context context2 = linearLayout.getContext();
        AbstractC19074t.m100207e(context2, "getContext(...)");
        C23623c c23623c = new C23623c(context2);
        c23623c.m123841p1().setIdTracking("scan_qr_result_text_copy");
        ...
        c23623c.m123841p1().m91111q1(AbstractC23322a.zds_ic_copy_line_24);
        c23623c.m123841p1().m91114u1(AbstractC8020f0.str_qr_noti_content_cta);
        c23623c.m123841p1().mo89109M0(new C16719g.c() { // from class: ry.w
            @Override // com.zing.zalo.uidrawing.C16719g.c
            /* renamed from: y */
            public final void mo929y(C16719g c16719g) {
                TextSheet.m49601OL(TextSheet.this, c16719g);
            }
        });
        c23623c.m123840o1().mo89109M0(new C16719g.c() { // from class: ry.x
            @Override // com.zing.zalo.uidrawing.C16719g.c
            /* renamed from: y */
            public final void mo929y(C16719g c16719g) {
                TextSheet.m49602PL(TextSheet.this, c16719g);
            }
        });
        c23623c.m89106L().m89023G(this.f49153b1);
        c16716d.m89001g1(c23623c);
        this.f49154c1 = c23623c;
