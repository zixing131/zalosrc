...
public final class ServiceUsage$$serializer implements InterfaceC26842x {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m114047n("cloud_media", true);
        pluginGeneratedSerialDescriptor.m114047n("my_cloud", true);
        pluginGeneratedSerialDescriptor.m114047n("message_backup", true);
    ...
    public ServiceUsage deserialize(Decoder decoder) {
        ...
        return new ServiceUsage(i11, j12, j13, j11, null);
    }
    ...
    public void serialize(Encoder encoder, ServiceUsage serviceUsage) {
        ...
        ServiceUsage.m41377d(serviceUsage, mo113984b, descriptor2);
