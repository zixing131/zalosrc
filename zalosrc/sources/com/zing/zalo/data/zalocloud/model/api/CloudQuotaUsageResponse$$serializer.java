...
public final class CloudQuotaUsageResponse$$serializer implements InterfaceC26842x {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m114047n("plan", false);
        pluginGeneratedSerialDescriptor.m114047n("quota", false);
        pluginGeneratedSerialDescriptor.m114047n("usage", false);
        pluginGeneratedSerialDescriptor.m114047n("service_usage", false);
    ...
    public KSerializer[] childSerializers() {
        ...
        return new KSerializer[]{C26783d0.f126989a, c26810m0, c26810m0, ServiceUsage$$serializer.INSTANCE, AbstractC25935a.m133630u(AbuseInfo$$serializer.INSTANCE)};
    }
    ...
    public CloudQuotaUsageResponse deserialize(Decoder decoder) {
        ...
        if (mo113968b.mo114015q()) {
            ...
            i11 = mo114011i;
            serviceUsage = (ServiceUsage) mo113968b.mo114012l(descriptor2, 3, ServiceUsage$$serializer.INSTANCE, null);
            abuseInfo = (AbuseInfo) mo113968b.mo114018x(descriptor2, 4, AbuseInfo$$serializer.INSTANCE, null);
            j11 = mo114010f;
            j12 = mo114010f2;
            i12 = 31;
        } else {
            ...
            while (z11) {
                ...
                if (mo114037p == -1) {
                    ...
                    serviceUsage2 = (ServiceUsage) mo113968b.mo114012l(descriptor2, 3, ServiceUsage$$serializer.INSTANCE, serviceUsage2);
                    i14 |= 8;
                } else {
                    if (mo114037p != 4) {
                        throw new UnknownFieldException(mo114037p);
                    }
                    abuseInfo2 = (AbuseInfo) mo113968b.mo114018x(descriptor2, 4, AbuseInfo$$serializer.INSTANCE, abuseInfo2);
                    i14 |= 16;
                }
            }
            i11 = i13;
        ...
        return new CloudQuotaUsageResponse(i12, i11, j11, j12, serviceUsage, abuseInfo, null);
    }
    ...
    public void serialize(Encoder encoder, CloudQuotaUsageResponse cloudQuotaUsageResponse) {
        ...
        AbstractC19074t.m100208f(cloudQuotaUsageResponse, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        InterfaceC21886d mo113984b = encoder.mo113984b(descriptor2);
        CloudQuotaUsageResponse.m41299f(cloudQuotaUsageResponse, mo113984b, descriptor2);
