...
public class AddCatalogItemView extends ListItem {
    public static final C9058a Companion = new C9058a(null);

    /* renamed from: H */
    private static final int f48519H = AbstractC23222t7.f112539R;

    /* renamed from: I */
    private static final int f48520I = AbstractC23222t7.f112514B;

    /* renamed from: G */
    private final RecyclingImageView f48521G;

    /* renamed from: com.zing.zalo.productcatalog.ui.widget.AddCatalogItemView$a */
    /* loaded from: classes4.dex */
    public static final class C9058a {
        private C9058a() {
        }

        public /* synthetic */ C9058a(AbstractC19060k abstractC19060k) {
            this();
        }
    }
    ...
    public AddCatalogItemView(Context context, AttributeSet attributeSet, int i11) {
        ...
        String string = getResources().getString(AbstractC8020f0.product_catalog_manage_item_add_catalog);
        ...
        roundCornerImageView.setImageDrawable(C27280g.m139660c(context, AbstractC23322a.zds_ic_create_catalog_line_24, AbstractC2807a.selected));
        this.f48521G = roundCornerImageView;
        int i12 = f48519H;
