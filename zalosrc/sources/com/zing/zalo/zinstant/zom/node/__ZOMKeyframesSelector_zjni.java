...
public class __ZOMKeyframesSelector_zjni {
    ...
    private static ZOMKeyframesSelector _$create(int i11, ZOMKeyframesStyles zOMKeyframesStyles) {
        return new ZOMKeyframesSelector(i11, zOMKeyframesStyles);
    }

    private static ZOMKeyframesSelector[] _$create_array(int i11) {
        return new ZOMKeyframesSelector[i11];
    }

    private static void _$set_element(ZOMKeyframesSelector[] zOMKeyframesSelectorArr, ZOMKeyframesSelector zOMKeyframesSelector, int i11) {
        zOMKeyframesSelectorArr[i11] = zOMKeyframesSelector;
    }
    ...
    public static ZOMKeyframesSelector[] convertPointerArrayToZOMKeyframesSelectorArray(long[] jArr) {
        ZOMKeyframesSelector[] zOMKeyframesSelectorArr = new ZOMKeyframesSelector[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMKeyframesSelectorArr[i11] = (ZOMKeyframesSelector) getObjectFromPointer(jArr[i11]);
        }
        return zOMKeyframesSelectorArr;
    }
