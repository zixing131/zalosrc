...
public class __ZOMMeta_zjni {
    ...
    private static ZOMMeta _$create(byte[] bArr, Object[] objArr) {
        return new ZOMMeta(bArr, objArr);
    }

    private static ZOMMeta[] _$create_array(int i11) {
        return new ZOMMeta[i11];
    }

    private static void _$set_element(ZOMMeta[] zOMMetaArr, ZOMMeta zOMMeta, int i11) {
        zOMMetaArr[i11] = zOMMeta;
    }
    ...
    public static ZOMMeta[] convertPointerArrayToZOMMetaArray(long[] jArr) {
        ZOMMeta[] zOMMetaArr = new ZOMMeta[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMMetaArr[i11] = (ZOMMeta) getObjectFromPointer(jArr[i11]);
        }
        return zOMMetaArr;
    }
