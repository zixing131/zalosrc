...
public class __ZOMDotLoading_zjni {
    ...
    private static ZOMDotLoading _$create(ZOMTransformElement[] zOMTransformElementArr, float f11, int i11, int i12) {
        return new ZOMDotLoading(zOMTransformElementArr, f11, i11, i12);
    }
    ...
    public static ZOMDotLoading[] convertPointerArrayToZOMDotLoadingArray(long[] jArr) {
        ZOMDotLoading[] zOMDotLoadingArr = new ZOMDotLoading[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMDotLoadingArr[i11] = (ZOMDotLoading) getObjectFromPointer(jArr[i11]);
        }
        return zOMDotLoadingArr;
    }
