...
public class __ZOMAnchor_zjni {
    ...
    private static ZOMAnchor _$create(int i11, int i12) {
        return new ZOMAnchor(i11, i12);
    }
    ...
    public static ZOMAnchor[] convertPointerArrayToZOMAnchorArray(long[] jArr) {
        ZOMAnchor[] zOMAnchorArr = new ZOMAnchor[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMAnchorArr[i11] = (ZOMAnchor) getObjectFromPointer(jArr[i11]);
        }
        return zOMAnchorArr;
    }
