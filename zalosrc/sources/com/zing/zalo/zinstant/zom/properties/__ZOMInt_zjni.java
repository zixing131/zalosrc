...
public class __ZOMInt_zjni {
    ...
    private static ZOMInt _$create(int i11) {
        return new ZOMInt(i11);
    }
    ...
    public static ZOMInt[] convertPointerArrayToZOMIntArray(long[] jArr) {
        ZOMInt[] zOMIntArr = new ZOMInt[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMIntArr[i11] = (ZOMInt) getObjectFromPointer(jArr[i11]);
        }
        return zOMIntArr;
    }
