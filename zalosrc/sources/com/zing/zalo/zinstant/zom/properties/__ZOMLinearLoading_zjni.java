...
public class __ZOMLinearLoading_zjni {
    ...
    private static ZOMLinearLoading _$create(int i11, float f11, int i12) {
        return new ZOMLinearLoading(i11, f11, i12);
    }
    ...
    public static ZOMLinearLoading[] convertPointerArrayToZOMLinearLoadingArray(long[] jArr) {
        ZOMLinearLoading[] zOMLinearLoadingArr = new ZOMLinearLoading[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMLinearLoadingArr[i11] = (ZOMLinearLoading) getObjectFromPointer(jArr[i11]);
        }
        return zOMLinearLoadingArr;
    }
