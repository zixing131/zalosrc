...
public class __ZOMTimingFunction_zjni {
    ...
    private static ZOMTimingFunction _$create(ZOMTimingFunctionSteps zOMTimingFunctionSteps, ZOMTimingFunctionCubicBezier zOMTimingFunctionCubicBezier) {
        return new ZOMTimingFunction(zOMTimingFunctionSteps, zOMTimingFunctionCubicBezier);
    }
    ...
    public static ZOMTimingFunction[] convertPointerArrayToZOMTimingFunctionArray(long[] jArr) {
        ZOMTimingFunction[] zOMTimingFunctionArr = new ZOMTimingFunction[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMTimingFunctionArr[i11] = (ZOMTimingFunction) getObjectFromPointer(jArr[i11]);
        }
        return zOMTimingFunctionArr;
    }
