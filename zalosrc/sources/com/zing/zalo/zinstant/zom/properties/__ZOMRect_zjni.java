...
public class __ZOMRect_zjni {
    ...
    private static ZOMRect _$create(float f11, float f12, float f13, float f14) {
        return new ZOMRect(f11, f12, f13, f14);
    }
    ...
    public static ZOMRect[] convertPointerArrayToZOMRectArray(long[] jArr) {
        ZOMRect[] zOMRectArr = new ZOMRect[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMRectArr[i11] = (ZOMRect) getObjectFromPointer(jArr[i11]);
        }
        return zOMRectArr;
    }
