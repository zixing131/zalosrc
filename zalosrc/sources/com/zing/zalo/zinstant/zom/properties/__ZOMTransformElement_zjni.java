...
public class __ZOMTransformElement_zjni {
    ...
    private static ZOMTransformElement _$create() {
        return new ZOMTransformElement();
    }

    private static ZOMTransformElement[] _$create_array(int i11) {
        return new ZOMTransformElement[i11];
    }

    private static void _$set_element(ZOMTransformElement[] zOMTransformElementArr, ZOMTransformElement zOMTransformElement, int i11) {
        zOMTransformElementArr[i11] = zOMTransformElement;
    }
    ...
    public static ZOMTransformElement[] convertPointerArrayToZOMTransformElementArray(long[] jArr) {
        ZOMTransformElement[] zOMTransformElementArr = new ZOMTransformElement[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMTransformElementArr[i11] = (ZOMTransformElement) getObjectFromPointer(jArr[i11]);
        }
