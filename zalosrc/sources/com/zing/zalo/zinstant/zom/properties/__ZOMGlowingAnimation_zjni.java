...
public class __ZOMGlowingAnimation_zjni {
    ...
    private static ZOMGlowingAnimation _$create(float f11, int i11, int i12, int i13, int i14, int i15, int i16) {
        return new ZOMGlowingAnimation(f11, i11, i12, i13, i14, i15, i16);
    }
    ...
    public static ZOMGlowingAnimation[] convertPointerArrayToZOMGlowingAnimationArray(long[] jArr) {
        ZOMGlowingAnimation[] zOMGlowingAnimationArr = new ZOMGlowingAnimation[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMGlowingAnimationArr[i11] = (ZOMGlowingAnimation) getObjectFromPointer(jArr[i11]);
        }
        return zOMGlowingAnimationArr;
    }
