...
public class __ZOMValue_zjni {
    ...
    private static ZOMValue _$create(int i11, float f11) {
        return new ZOMValue(i11, f11);
    }
    ...
    public static ZOMValue[] convertPointerArrayToZOMValueArray(long[] jArr) {
        ZOMValue[] zOMValueArr = new ZOMValue[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMValueArr[i11] = (ZOMValue) getObjectFromPointer(jArr[i11]);
        }
        return zOMValueArr;
    }
