...
public class __ZOMClickEffect_zjni {
    ...
    private static ZOMClickEffect _$create(int i11) {
        return new ZOMClickEffect(i11);
    }
    ...
    public static ZOMClickEffect[] convertPointerArrayToZOMClickEffectArray(long[] jArr) {
        ZOMClickEffect[] zOMClickEffectArr = new ZOMClickEffect[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMClickEffectArr[i11] = (ZOMClickEffect) getObjectFromPointer(jArr[i11]);
        }
        return zOMClickEffectArr;
    }
