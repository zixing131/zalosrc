...
public class __ZOMBoxShadow_zjni {
    ...
    private static ZOMBoxShadow _$create(int i11, int i12, int i13, int i14, int i15) {
        return new ZOMBoxShadow(i11, i12, i13, i14, i15);
    }
    ...
    public static ZOMBoxShadow[] convertPointerArrayToZOMBoxShadowArray(long[] jArr) {
        ZOMBoxShadow[] zOMBoxShadowArr = new ZOMBoxShadow[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMBoxShadowArr[i11] = (ZOMBoxShadow) getObjectFromPointer(jArr[i11]);
        }
        return zOMBoxShadowArr;
    }
