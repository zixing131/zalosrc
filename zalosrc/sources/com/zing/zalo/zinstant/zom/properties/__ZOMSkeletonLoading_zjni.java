...
public class __ZOMSkeletonLoading_zjni {
    ...
    private static ZOMSkeletonLoading _$create(int i11, float f11, int i12, int i13, float f12, float f13) {
        return new ZOMSkeletonLoading(i11, f11, i12, i13, f12, f13);
    }
    ...
    public static ZOMSkeletonLoading[] convertPointerArrayToZOMSkeletonLoadingArray(long[] jArr) {
        ...
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMSkeletonLoadingArr[i11] = (ZOMSkeletonLoading) getObjectFromPointer(jArr[i11]);
        }
