...
public class __ZOMAnimation_zjni {
    ...
    private static ZOMAnimation _$create() {
    ...
    public static ZOMAnimation[] convertPointerArrayToZOMAnimationArray(long[] jArr) {
        ZOMAnimation[] zOMAnimationArr = new ZOMAnimation[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMAnimationArr[i11] = (ZOMAnimation) getObjectFromPointer(jArr[i11]);
        }
        return zOMAnimationArr;
    }
    ...
    private static void setData(ZOMAnimation zOMAnimation, Object[] objArr) {
        if (zOMAnimation != null) {
            zOMAnimation.setData(objArr);
        }
    }
}
