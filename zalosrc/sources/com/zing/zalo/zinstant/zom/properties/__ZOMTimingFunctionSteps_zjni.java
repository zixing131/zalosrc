...
public class __ZOMTimingFunctionSteps_zjni {
    ...
    private static ZOMTimingFunctionSteps _$create(int i11, int i12) {
        return new ZOMTimingFunctionSteps(i11, i12);
    }
    ...
    public static ZOMTimingFunctionSteps[] convertPointerArrayToZOMTimingFunctionStepsArray(long[] jArr) {
        ZOMTimingFunctionSteps[] zOMTimingFunctionStepsArr = new ZOMTimingFunctionSteps[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMTimingFunctionStepsArr[i11] = (ZOMTimingFunctionSteps) getObjectFromPointer(jArr[i11]);
        }
        return zOMTimingFunctionStepsArr;
    }
