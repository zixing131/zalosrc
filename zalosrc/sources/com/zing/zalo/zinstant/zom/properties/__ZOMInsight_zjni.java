...
public class __ZOMInsight_zjni {
    ...
    private static ZOMInsight _$create() {
    ...
    public static ZOMInsight[] convertPointerArrayToZOMInsightArray(long[] jArr) {
        ZOMInsight[] zOMInsightArr = new ZOMInsight[jArr.length];
        for (int i11 = 0; i11 < jArr.length; i11++) {
            zOMInsightArr[i11] = (ZOMInsight) getObjectFromPointer(jArr[i11]);
        }
        return zOMInsightArr;
    }
    ...
    private static ZOMInsight _$create(byte[] bArr, byte[] bArr2, byte[] bArr3, int i11, int i12, int i13) {
        return new ZOMInsight(bArr, bArr2, bArr3, i11, i12, i13);
    }
}
