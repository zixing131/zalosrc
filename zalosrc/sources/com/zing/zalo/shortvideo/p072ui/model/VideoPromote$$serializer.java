...
public final class VideoPromote$$serializer implements InterfaceC26842x {
    public static final VideoPromote$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        VideoPromote$$serializer videoPromote$$serializer = new VideoPromote$$serializer();
        INSTANCE = videoPromote$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.zing.zalo.shortvideo.ui.model.VideoPromote", videoPromote$$serializer, 3);
    ...
    private VideoPromote$$serializer() {
    }
    ...
    public VideoPromote deserialize(Decoder decoder) {
        int i11;
        String str;
        String str2;
        String str3;
        ...
        return new VideoPromote(i11, str, str2, str3, null);
    }
    ...
    public void serialize(Encoder encoder, VideoPromote videoPromote) {
        AbstractC19074t.m100208f(encoder, "encoder");
        AbstractC19074t.m100208f(videoPromote, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        InterfaceC21886d mo113984b = encoder.mo113984b(descriptor2);
        VideoPromote.m52957d(videoPromote, mo113984b, descriptor2);
