...
public final class PagingLoadMoreInfo$$serializer implements InterfaceC26842x {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.m114047n("lastId", true);
        pluginGeneratedSerialDescriptor.m114047n("lastIndex", true);
    ...
    public KSerializer[] childSerializers() {
        ...
        return new KSerializer[]{C26794h.f127000a, c26814n1, c26814n1, c26814n1, c26814n1};
    }
    ...
    public PagingLoadMoreInfo deserialize(Decoder decoder) {
        ...
        if (mo113968b.mo114015q()) {
            ...
            str2 = mo113968b.mo114014o(descriptor2, 4);
            str3 = mo114014o2;
            str4 = mo114014o;
            i11 = 31;
        } else {
            ...
            while (z13) {
                ...
                if (mo114037p == -1) {
                    ...
                    str5 = mo113968b.mo114014o(descriptor2, 3);
                    i12 |= 8;
                } else {
                    if (mo114037p != 4) {
        ...
        return new PagingLoadMoreInfo(i11, z11, str4, str3, str, str2, null);
    }
    ...
    public void serialize(Encoder encoder, PagingLoadMoreInfo pagingLoadMoreInfo) {
        ...
        AbstractC19074t.m100208f(pagingLoadMoreInfo, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        InterfaceC21886d mo113984b = encoder.mo113984b(descriptor2);
        PagingLoadMoreInfo.m51092h(pagingLoadMoreInfo, mo113984b, descriptor2);
