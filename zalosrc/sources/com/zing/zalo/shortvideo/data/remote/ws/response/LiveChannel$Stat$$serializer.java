...
public final class LiveChannel$Stat$$serializer implements InterfaceC26842x {
    public static final LiveChannel$Stat$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        LiveChannel$Stat$$serializer liveChannel$Stat$$serializer = new LiveChannel$Stat$$serializer();
        INSTANCE = liveChannel$Stat$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.zing.zalo.shortvideo.data.remote.ws.response.LiveChannel.Stat", liveChannel$Stat$$serializer, 6);
        pluginGeneratedSerialDescriptor.m114047n("videos", true);
        pluginGeneratedSerialDescriptor.m114047n("followers", true);
        pluginGeneratedSerialDescriptor.m114047n("likes", true);
        pluginGeneratedSerialDescriptor.m114047n("views", true);
        pluginGeneratedSerialDescriptor.m114047n("shares", true);
        pluginGeneratedSerialDescriptor.m114047n("cmts", true);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private LiveChannel$Stat$$serializer() {
    }
    ...
    public LiveChannel.Stat deserialize(Decoder decoder) {
        int i11;
        Long l11;
        Long l12;
        Long l13;
        ...
        return new LiveChannel.Stat(i11, l11, l12, l13, l14, l15, l16, null);
    }
    ...
    public void serialize(Encoder encoder, LiveChannel.Stat stat) {
        AbstractC19074t.m100208f(encoder, "encoder");
        AbstractC19074t.m100208f(stat, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        InterfaceC21886d mo113984b = encoder.mo113984b(descriptor2);
        LiveChannel.Stat.m51676d(stat, mo113984b, descriptor2);
