...
/* renamed from: com.zing.zalo.zview.p0 */
/* loaded from: classes7.dex */
public abstract class AbstractC17489p0 extends C17487o0 {
    ...
    public ZaloView mo57057c2(int i11, Class cls, Bundle bundle, int i12, String str, int i13, boolean z11) {
        try {
            ...
            if (bundle != null && bundle.containsKey("SHOW_WITH_FLAGS") && (bundle.getInt("SHOW_WITH_FLAGS") & 67108864) == 67108864) {
                ArrayList arrayList = new ArrayList(this.f89110d);
    ...
    public void mo93079r1(boolean z11) {
        if (z11) {
            while (this.f89110d.size() > 0) {
                m93010J1((C17478k) this.f89110d.get(r2.size() - 1));
            }
        }
    }
}
