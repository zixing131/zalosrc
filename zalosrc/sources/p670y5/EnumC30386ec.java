...
public enum EnumC30386ec implements InterfaceC30471j2 {
    NO_ERROR(0),
    ...
    REMOTE_MODEL_INVALID(ZVideoUtilMetadata.FF_PROFILE_H264_HIGH_10),
    ...
    /* renamed from: p */
    private final int f140894p;

    EnumC30386ec(int i11) {
        this.f140894p = i11;
    }

    @Override // p670y5.InterfaceC30471j2
    public final int zza() {
        return this.f140894p;
    }
}
