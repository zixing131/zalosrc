...
public enum EnumC30405fc implements InterfaceC30471j2 {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_IMAGE_LABEL_LOAD(ZVideoUtilMetadata.FF_PROFILE_H264_HIGH_444),
    ...
    ON_DEVICE_ENTITY_EXTRACTION_CLOSE(ZVideoUtilMetadata.FF_PROFILE_H264_HIGH_444_PREDICTIVE),
    ...
    CLOUD_TEXT_DETECT(ZVideoUtilMetadata.FF_PROFILE_H264_HIGH_422),
    ...
    /* renamed from: p */
    private final int f141157p;

    EnumC30405fc(int i11) {
        this.f141157p = i11;
    }

    @Override // p670y5.InterfaceC30471j2
    public final int zza() {
        return this.f141157p;
    }
}
