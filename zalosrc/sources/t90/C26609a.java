...
public final class C26609a extends C31713f {

    /* renamed from: Y */
    private long f125947Y;

    /* renamed from: Z */
    private boolean f125948Z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C26609a(InterfaceC27130h2 interfaceC27130h2) {
        super(interfaceC27130h2);
        AbstractC19074t.m100208f(interfaceC27130h2, "mvpView");
    }

    /* renamed from: fr */
    private final void m136570fr(boolean z11, int i11, long j11) {
        C0815e1.m2075D().m2100V(new C23648e(1, "csc_attach", 1, "chat_send_mycloud_links", "4", C0815e1.m2075D().m2119t("4", "204278670", z11, i11, j11)), false);
    }

    /* renamed from: gr */
    private final boolean m136571gr(List list, MessageId messageId) {
        List list2 = list;
    ...
    public void mo70494cd(C2665b c2665b) {
        ...
        if (this.f125947Y != 0) {
            if ((!c2665b.m13088g().isEmpty()) || !m70468Kq()) {
                m136570fr(c2665b.m13088g().isEmpty(), 0, System.currentTimeMillis() - this.f125947Y);
                this.f125947Y = 0L;
                this.f125948Z = true;
            }
        }
    ...
    public void mo70497dq(boolean z11) {
        ...
        if (!this.f125948Z) {
            this.f125948Z = true;
            this.f125947Y = System.currentTimeMillis();
        }
    }
        ...
        if (!arrayList.isEmpty()) {
            for (C2666c c2666c : m70507nq().m13088g().values()) {
                for (MyCloudMessageItem myCloudMessageItem : c2666c.m13098c()) {
                    myCloudMessageItem.m71025i(m136571gr(arrayList, myCloudMessageItem.m71033m().m95029V3()));
                }
