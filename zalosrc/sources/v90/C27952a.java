...
public final class C27952a extends C3379g {

    /* renamed from: Y */
    private long f130307Y;

    /* renamed from: Z */
    private boolean f130308Z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C27952a(InterfaceC27130h2 interfaceC27130h2) {
        super(interfaceC27130h2);
        AbstractC19074t.m100208f(interfaceC27130h2, "mvpView");
    }

    /* renamed from: fr */
    private final void m140878fr(boolean z11, int i11, long j11) {
        C0815e1.m2075D().m2100V(new C23648e(1, "csc_attach", 1, "chat_send_mycloud_txt", "4", C0815e1.m2075D().m2119t("4", "204278670", z11, i11, j11)), false);
    }

    /* renamed from: gr */
    private final boolean m140879gr(List list, MessageId messageId) {
        List list2 = list;
    ...
    public void mo70494cd(C2665b c2665b) {
        ...
        if (this.f130307Y != 0) {
            if ((!c2665b.m13088g().isEmpty()) || !m70468Kq()) {
                m140878fr(c2665b.m13088g().isEmpty(), 0, System.currentTimeMillis() - this.f130307Y);
                this.f130307Y = 0L;
                this.f130308Z = true;
            }
        }
    ...
    public void mo70497dq(boolean z11) {
        ...
        if (!this.f130308Z) {
            this.f130308Z = true;
            this.f130307Y = System.currentTimeMillis();
        }
    }
        ...
        if (!arrayList.isEmpty()) {
            for (C2666c c2666c : m70507nq().m13088g().values()) {
                for (MyCloudMessageItem myCloudMessageItem : c2666c.m13098c()) {
                    myCloudMessageItem.m71025i(m140879gr(arrayList, myCloudMessageItem.m71033m().m95029V3()));
                }
