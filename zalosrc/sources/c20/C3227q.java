...
public final class C3227q extends C1929v {

    /* renamed from: f */
    private RecyclerView f13775f;

    /* renamed from: g */
    private RecyclerView.AbstractC1890q f13776g;

    /* renamed from: c20.q$a */
    /* loaded from: classes5.dex */
    public static final class a extends C1923p {

        /* renamed from: r */
        final /* synthetic */ RecyclerView.AbstractC1888o f13778r;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(RecyclerView.AbstractC1888o abstractC1888o, Context context) {
            super(context);
            this.f13778r = abstractC1888o;
        }
        ...
        public void mo10243o(View view, RecyclerView.C1899z c1899z, RecyclerView.AbstractC1898y.a aVar) {
            ...
            int[] mo10398c = C3227q.this.mo10398c(this.f13778r, view);
        ...
        public int mo10624x(int i11) {
            return Math.min(50, super.mo10624x(i11));
        }
    }
    ...
    public boolean mo10175a(int i11, int i12) {
        RecyclerView.AbstractC1890q abstractC1890q = this.f13776g;
    ...
    protected C1923p mo10401f(RecyclerView.AbstractC1888o abstractC1888o) {
        ...
        RecyclerView recyclerView = this.f13775f;
        AbstractC19074t.m100205c(recyclerView);
        return new a(abstractC1888o, recyclerView.getContext());
    }

    /* renamed from: t */
    public final void m16365t(RecyclerView.AbstractC1890q abstractC1890q) {
        this.f13776g = abstractC1890q;
    }

    /* renamed from: u */
    public final void m16366u(int i11) {
